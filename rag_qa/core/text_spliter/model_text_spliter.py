...
parent1_dir = os.path.dirname(current_dir)
parent2_dir = os.path.dirname(parent1_dir)
class AliTextSplitter(CharacterTextSplitter):
    ...
    def split_text(self, text: str) -> List[str]:
        ...
        p = pipeline(
            ...
            model=os.path.join(parent2_dir,'models','nlp_bert_document-segmentation_chinese-base'),
            device="cpu")
